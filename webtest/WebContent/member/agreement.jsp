...
<div class="container">
<h3 class="col-sm-offset-3 col-sm-10">약관동의</h3><br>
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.  
   ...
   <label for="agree" ><input type="checkbox" name="agree" id="agree" value="1" > 약관에 동의합니다 <br></label>
    <button class="btn">회원가입</button>
    <button type="reset" value="취소" onclick="history.back();" class="btn">취소</button>
   </div>
 </div>
</form>
</div>
